...
export class AlphabetEn extends Alphabet {
  ...
  symbols: ISymbol[] = [
    ...
    {symbol: ".", dots: [0, 1, 0, 0, 1, 1]},
    {symbol: ",", dots: [0, 1, 0, 0, 0, 0]},
    {symbol: "?", dots: [0, 1, 0, 0, 1, 0]},
    {symbol: "!", dots: [0, 1, 1, 0, 1, 0]},
    {symbol: ";", dots: [0, 1, 1, 0, 0, 0]},
    {symbol: ":", dots: [0, 1, 0, 0, 1, 0]},
    {symbol: "-", dots: [0, 0, 1, 0, 0, 1]},
    {symbol: "'", dots: [0, 0, 1, 0, 0, 0]},
    {symbol: "(", dots: [0, 1, 1, 0, 0, 1]},
    {symbol: ")", dots: [0, 0, 1, 1, 0, 1]},
    {symbol: "/", dots: [0, 0, 1, 1, 0, 0]},
    {symbol: "@", dots: [0, 0, 0, 1, 0, 0]},
  ]
}
...
export class AlphabetRu extends Alphabet {
  symbols: ISymbol[] = [
    ...
    {symbol: "П", dots: [1,1,1,1,0,0]},
    {symbol: "Р", dots: [1,1,1,0,1,0]},
    {symbol: "С", dots: [0,1,1,1,0,0]},
    {symbol: "Т", dots: [0,1,1,1,1,0]},
    {symbol: "У", dots: [1,0,1,0,0,1]},
    {symbol: "Ф", dots: [1,1,0,1,0,0]},
    {symbol: "Х", dots: [1,1,0,0,1,0]},
    {symbol: "Ц", dots: [1,0,0,1,0,0]},
    {symbol: "Ч", dots: [1,1,1,1,1,0]},
    {symbol: "Ш", dots: [1,0,0,0,1,1]},
    {symbol: "Щ", dots: [1,0,1,1,0,1]},
    {symbol: "Ь", dots: [0,1,1,1,0,1]},
    {symbol: "Ы", dots: [0,1,1,1,1,1]},
    {symbol: "Ъ", dots: [1,1,1,0,0,1]},
    {symbol: "Э", dots: [0,1,0,1,0,1]},
    {symbol: "Ю", dots: [1,1,0,0,0,1]},
    {symbol: "Я", dots: [1,0,1,0,1,1]},
  ]
}
