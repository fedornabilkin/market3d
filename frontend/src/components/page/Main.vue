  ...
  .animation-section.box(ref="examplesRef")
    .columns.is-vcentered
      .column.is-half
        ...
        p.subtitle.is-5 Настраиваете параметры в форме — конструктор собирает 3D-модель на ваших глазах и готовит STL-файл для 3D-печати.
        p Сцена справа последовательно собирает QR-код STL, брелок с текстом, подставку, табличку Брайля и финальный бейдж из конструктора — так проще понять, какой генератор подходит под вашу задачу.
      .column.is-half
        AnimationScene
    ...
    .columns.is-multiline
        ...
        .card.feature-card
          .card-header.has-background-primary
            p.card-header-title.has-text-white
              ...
              | Генератор QR-кода
          .card-content
            p Трёхмерный QR-код со ссылкой, контактом, Wi-Fi или любой другой информацией. Добавьте подпись, иконку, рамку и петельку — получите QR-код STL для визитки, брелока или сувенира, который можно распечатать на 3D-принтере.
      ...
      .column.is-one-third
        .card.feature-card
          ...
          .card-content
            p Объёмные буквы с подложкой, фаской, случайной высотой и петелькой в любом углу. Генератор брелоков STL помогает сделать брелок с именем, словом или короткой надписью; есть четыре встроенных шрифта и загрузка собственного.
